...
export default function FriendOutgoingCard(userData:{userId:string, userName:string, sentAt:Date, imgUrl:string, requestId:number}) {
  ...
  <Card sx={{width: 320, height: 150}}>
      ...
      <CardActions sx={{display:"flex", justifyContent:"center"}}>
        <Button variant='outlined' sx={{width:'100%'}} onClick={() => cancelRequest(userData.requestId)}><CloseIcon/></Button>
      </CardActions>
  </Card>
  )
}